function [y,e] = SSLMS_subFilter(input)
%% Signed sparse least mean square subfilter for use with Hybrid_Filter.m
%   Based on Martin et al.: Exploiting sparsity in adaptive filters
