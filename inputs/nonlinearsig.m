function [output] = nonlinearsig(leng,comp,noise)
%% Creates a nonlinear signal based on Model III from Narendra & Parthasarathy: Identification and control of dynamical systems using neural networks 
...
for k=1:leng-1
     output(k+1) = output(k)/(1+output(k)^2) + noise(k)^3;
end